...
DEFAULT_CONFIG_VALUES = {
    ...
    "hsem_secondary_storage_enabled": False,
    "hsem_secondary_storage_control_enabled": False,
    "hsem_secondary_storage_soc_entity": "sensor.powmr_soc",
    "hsem_secondary_storage_battery_net_power_entity": "sensor.powmr_battery_net_power",
    "hsem_secondary_storage_load_power_entity": "sensor.powmr_load_power_internal",
    "hsem_secondary_storage_output_source_priority_entity": "select.powmr_output_source_priority",
    "hsem_secondary_storage_charger_source_priority_entity": "select.powmr_charger_source_priority",
    "hsem_secondary_storage_max_charge_current_entity": "number.powmr_max_total_charge_current",
    "hsem_secondary_storage_capacity_kwh": 15.0,
    "hsem_secondary_storage_min_soc_pct": 20.0,
    "hsem_secondary_storage_max_soc_pct": 100.0,
    "hsem_secondary_storage_nominal_voltage_v": 24.0,
    "hsem_secondary_storage_min_charge_current_a": 10.0,
    "hsem_secondary_storage_max_charge_current_a": 60.0,
    "hsem_secondary_storage_charge_efficiency_pct": 93.0,
    "hsem_secondary_storage_discharge_efficiency_pct": 93.0,
    "hsem_secondary_storage_inverter_standby_power_w": 55.0,
