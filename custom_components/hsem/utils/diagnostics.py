...
def _slot_to_dict(slot: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "import_price_available": bool(getattr(slot, "import_price_available", True)),
        "export_price_available": bool(getattr(slot, "export_price_available", True)),
        "import_price_source": getattr(slot, "import_price_source", None),
        "export_price_source": getattr(slot, "export_price_source", None),
